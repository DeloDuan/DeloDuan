    ...
    private static final class InternalSurfaceHolder implements IRenderView.ISurfaceHolder {
        ...
        public void bindToMediaPlayer(IMediaPlayer mp) {
            ...
            if(mp instanceof IjkMediaPlayer){
                ((IjkMediaPlayer)mp).setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "opensles", 0);
                ((IjkMediaPlayer)mp).setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "overlay-format", IjkMediaPlayer.SDL_FCC_RV32);
            }
        }
