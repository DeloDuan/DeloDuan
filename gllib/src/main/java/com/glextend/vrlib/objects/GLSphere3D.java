 ...
 */
public class GLSphere3D extends GLAbsObject3D {

    private static final String TAG = "GLSphere3D";
    ...
    private static void generateSphere(GLAbsObject3D object3D) {
     ...
     * */
    private static void generateSphere(float radius, int rings, int sectors, GLAbsObject3D object3D) {
