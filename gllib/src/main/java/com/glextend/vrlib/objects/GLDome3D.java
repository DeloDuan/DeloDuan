 ...
 */
public class GLDome3D extends GLAbsObject3D {
    ...
    public GLDome3D(RectF textureSize, float degree, boolean isUpper) {
    ...
    @Override
    public void uploadTexCoordinateBufferIfNeed(GL360Program program, int index) {
    ...
    private static void generateDome(float degree, boolean isUpper, GLDome3D object3D) {
        generateDome(18, 150, degree, isUpper, object3D);
    }

    public static void generateDome(float radius, int sectors, float degreeY, boolean isUpper, GLDome3D object3D) {
