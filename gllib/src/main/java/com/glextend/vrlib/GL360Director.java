 ...
 */
public class GL360Director {

    private static final String TAG = "GL360Director";
    ...
    protected GL360Director(Builder builder) {
    ...
    public void shot(GL360Program program) {
        shot(program, GLPosition.sOriginalPosition);
    }

    public void shot(GL360Program program, GLPosition modelPosition) {
    ...
    public static class Builder {
        ...
        public Builder setAngleX(float mAngle) {
            throw new RuntimeException("please use GLPosition");
        }
        ...
        public GL360Director build(){
            return new GL360Director(this);
        }
    }
}
